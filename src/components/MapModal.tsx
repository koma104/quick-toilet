          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="p-6 pt-0 md:p-10 md:pt-0">
              <a
                ...
                className="flex w-full items-center justify-center gap-3 rounded-2xl bg-sky-500 py-5 font-bold text-white shadow-xl shadow-sky-100 transition-all hover:bg-sky-600 active:scale-[0.98] dark:bg-sky-600 dark:shadow-sky-900/30 dark:hover:bg-sky-700"
              >
                <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
